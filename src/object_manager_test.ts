...
import { ObjectManagerImpl, ObjectManager, CollectionManager, Ajax } from 'django-client-framework-typescript';
...
describe('object manager tests', () => {
    ...
    it('test refresh', async () => {
        ...
        await Axios.patch('http://localhost:8000/product/1', {"barcode": "product 2"});
    ...
    it ('test constructor pass in object', async () => {
        ...
        var objm = new ObjectManagerImpl<Product>(ppr.objects[0]) as ObjectManager<Product>;
